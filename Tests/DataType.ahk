...
Test( "DataType",
    ...
    ( expect ) => expect( DataStruct.Address(), "STRUCT base address" ).ToBe( DataStruct.Ptr ),
    ( expect ) => expect( DataStruct.Address( "unknown" ), "STRUCT[unknown] address" ).ToBe( -1 ),
    ( expect ) => expect( DataStruct.Address( "data0" ), "STRUCT[data0] address" ).ToBe( DataStruct.Ptr ),
    ( expect ) => expect( DataStruct.Address( "data1" ), "STRUCT[data1] address" ).ToBe( DataStruct.Ptr + DataStruct.Size["data0"] ),
    ( expect ) => expect( DataStruct.Address( "data2" ), "STRUCT[data2] address" ).ToBe( DataStruct.Ptr + DataStruct.Size["data0"] + DataStruct.Size["data1"] ),
    ( expect ) => expect( DataStruct.Address( "data3" ), "STRUCT[data3] address" ).ToBe( DataStruct.Ptr + DataStruct.Size["data0"] + DataStruct.Size["data1"] + DataStruct.Size["data2"] ),
)
